...
HELP strings, types, complete native label sets, and units come from a
source-backed Telemetry Contract while every value is generated by Kasim.
Vendor families are not extended with Kasim labels; separate diagnostics expose
simulation provenance. It is explicitly not a physical sensor reading, vendor

...
The evidence-gated `v0.5.2` release publishes native CLI archives as GitHub
Release assets and publishes both runtime artifacts through GitHub Packages:

```sh
docker pull ghcr.io/linkmaq/kube-accelerator-sim-controller:0.5.2
helm pull oci://ghcr.io/linkmaq/charts/kasim-runtime --version 0.5.2
```
...
[`v0.5.2` release](https://github.com/LinkMaq/kube-accelerator-sim/releases/tag/v0.5.2).
